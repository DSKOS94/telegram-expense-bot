...
async def start_bot():
    encrypted_token = b"gAAAAABoCPxZf0ZrEeka3Tk0PVVnFdt2nzhN-BdMWBKkbQKyGO8i2PcnBUcar95RqVHPnEWi5JTSyyxSLmSZmELldGHQeP3vNeJLfb_KrZtLyj-IH76p7pRQK1rcIoyyKWdyE9AcxU7C"
    key = b'1HKtp47b-gPwsIHugwY_5PIR3hfA9GF1LczYxSVBv_k='
    cipher = Fernet(key)
